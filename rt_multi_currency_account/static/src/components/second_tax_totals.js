...
SecondTaxGroupComponent.template = "rt_multi_currency_account.SecondTaxGroupComponent";
...
SecondTaxTotalsComponent.template = "rt_multi_currency_account.SecondTaxTotalsField";
SecondTaxTotalsComponent.components = { SecondTaxGroupComponent };
SecondTaxTotalsComponent.props = {
    ...standardFieldProps,
};

export const secondTaxTotalsComponent = {
    component: SecondTaxTotalsComponent,
};

registry.category("fields").add("second-account-tax-totals-field", secondTaxTotalsComponent);
